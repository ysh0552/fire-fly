...
<div class="content-box-content"> 
	<div class="tab-content default-tab" id="tab1">
			  <form action="<?php echo site_url('a_ads1/save'); ?>" method="post" id="form1"  enctype="multipart/form-data" />
				...
				<p>排　序：<input type="text" name="sort" value="<?php echo $id?$sort:''; ?>"  class="text-input medium-input datepicker"/></p>
                   ...
                   <?php if($id == 12){ ?>
                     <p>
                    <textarea id="editor_id1" name="content2" style="height:400px;"><?php echo $id?$content2:''; ?></textarea>
                    </p>
                   <?php } ?>
