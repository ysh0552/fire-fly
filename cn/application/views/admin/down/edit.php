...
<div class="content-box-content"> 
	...
	<div class="tab-content default-tab" id="tab1">
					...
					<form action="<?php echo site_url('a_down/save'); ?>" method="post" id="form1"  enctype="multipart/form-data" />
                ...
                <input name="index" type="radio" value="0" <?php if($id){ echo $index == 0?'checked':''; }?> >否
					...
					<p>标　题：<input type="text" name="title" title="产品名" value="<?php echo $id?$title:'';?>"  class="text-input medium-input datepicker" />
                    </p>
