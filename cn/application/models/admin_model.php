...
class Admin_model extends CI_Model
{
	...
	{
		$this->db->insert('xz_cn_admin',$arr);
	}
	...
	{
		$this->db->where('id',$id);
		$this->db->update('xz_cn_admin',$str);
	}
	...
	{
		$this->db->where('id',$id);
		$this->db->delete('xz_cn_admin');
	}
	
	//get_where
	public function  user_get_where($arr)
	{
		$query=$this->db->get_where('xz_cn_admin',$arr);
		return $query->result_array();
	}
