<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="tab1">
			<form action="<?php echo site_url('a_qa/save'); ?>" method="post" enctype="multipart/form-data" >
				...
				<p>排序：
				<input type="text" name="sort" value="<?php echo $id?$sort:'';?>" class="text-input medium-input datepicker" />
				</p>
				<p>问题：
