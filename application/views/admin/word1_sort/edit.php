...
<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content"> 
					<form action="<?php echo site_url('a_word1_sort/save');?>" method="post" id="form1"  enctype="multipart/form-data" />
					<input type="hidden" name="id" value="<?php echo $id?$id:''; ?>" />
			
                
                    <script type="text/javascript">$('#sid').val(<?php echo $id?$data_sort[0]['sid']:''; ?>);</script>
