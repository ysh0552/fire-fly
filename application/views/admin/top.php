		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
				...
				<ul id="main-nav"> <!-- Accordion Menu -->
					<li>
                        ...
                        <li><a <?php echo $str=='a_ads'?'class="current"':''; ?> href="<?php echo site_url('a_ads'); ?>" >ENVIRONMENT/首页轮播图</a></li>

                        <li><a <?php echo $str=='a_word1'?'class="current"':''; ?>  href="<?php echo site_url('a_word1'); ?>" >TECHNOLOGY</a></li>

	                    <li><a <?php echo $str=='a_news'?'class="current"':''; ?>  href="<?php echo site_url('a_news'); ?>" >DISTRIBUTORS</a></li>

	                    <li><a <?php echo $str=='a_product'?'class="current"':''; ?> href="<?php echo site_url('a_product'); ?>" >PRODUCTS</a></li>
	                    
					    <li><a <?php echo $str=='a_ads1'?'class="current"':''; ?>  href="<?php echo site_url('a_ads1'); ?>" >INDUSTRIES</a></li> 
	                  
	                    <li><a <?php echo $str=='a_sort'?'class="current"':''; ?> href="<?php echo site_url('a_sort'); ?>" >PRODUCTS_SORT</a></li>
                        <li><a <?php echo $str=='a_case'?'class="current"':''; ?> href="<?php echo site_url('a_case'); ?>" >CASES</a></li>

	                    <li><a <?php echo $str=='a_down'?'class="current"':''; ?> href="<?php echo site_url('a_down'); ?>" >NEWS</a></li>

					    <li><a <?php echo $str=='a_contact'?'class="current"':''; ?>  href="<?php echo site_url('a_contact/edit/8'); ?>" >ABOUT</a></li> 
