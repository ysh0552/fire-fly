...
<div class="content-box-content"> 
	...
	<div class="tab-content default-tab" id="tab1">
			...
			<form action="<?php echo site_url('a_word1/save'); ?>" method="post" id="form1"  enctype="multipart/form-data" />
...
<p>上　传：<b>注意：只支持上传jpg,png,gif,bmp文件 图片尺寸(像素px)：239x240 </b><div id="queue"></div>
